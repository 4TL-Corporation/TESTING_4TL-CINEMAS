			...
			<div class="row ipad-width2">
				<div class="col-md-4 col-sm-12 col-xs-12">
					<div class="movie-img sticky-sb">
						<img src="./user/images/uploads/${videoImg }" alt="">
						<div class="movie-btn">
							<div class="btn-transform transform-vertical red">
								...
								<div>
									<a id="videoID" href="${videoTrailer }"
				...
				<div class="col-md-8 col-sm-12 col-xs-12">
					<div class="movie-single-ct main-content">
						<h1 class="bd-hd">
							${videoTitle } <span>2015</span>
						</h1>
						<div class="social-btn">
							<form action="LikeVideo" method="post">
							...
							<div class="hover-bnt">
								<a href="ShareVideo?videoID=${videoTrailer}" class="parent-btn"><i
						...
						<div class="movie-rate">
							<div class="rate">
								...
								<p>
									<span>8.1</span> /10<br> <span class="rv">${videoViews }
										Reviews</span>
								</p>
							</div>
							<div class="rate-star">
								...
								<div class="tab-content">
											...
											<div class="col-md-8 col-sm-12 col-xs-12">
												...
												<div class="mvsingle-item ov-item">
													<a class="img-lightbox" data-fancybox-group="gallery"
														href="./user/images/uploads/image11.jpg"><img
														src="images/uploads/image1.jpg" alt=""></a> <a
														class="img-lightbox" data-fancybox-group="gallery"
														href="./user/images/uploads/image21.jpg"><img
														src="./user/images/uploads/image2.jpg" alt=""></a> <a
														class="img-lightbox" data-fancybox-group="gallery"
														href="./user/images/uploads/image31.jpg"><img
														src="./user/images/uploads/image3.jpg" alt=""></a>
													<div class="vd-it">
														<img class="vd-img" src="./user/images/uploads/image4.jpg"
															alt=""> <a class="fancybox-media hvr-grow"
															href="https://www.youtube.com/embed/o-0hcF97wy0"><img
															src="./user/images/uploads/play-vd.png" alt=""></a>
													</div>
												</div>
												<div class="title-hd-sm">
													<h4>cast</h4>
												...
												<div class="mvcast-item">
													<div class="cast-it">
														<div class="cast-left">
															<img src="./user/images/uploads/cast1.jpg" alt="">
													...
													<div class="cast-it">
														<div class="cast-left">
															<img src="./user/images/uploads/cast2.jpg" alt="">
													...
													<div class="cast-it">
														<div class="cast-left">
															<img src="./user/images/uploads/cast3.jpg" alt="">
													...
													<div class="cast-it">
														<div class="cast-left">
															<img src="./user/images/uploads/cast4.jpg" alt="">
													...
													<div class="cast-it">
														<div class="cast-left">
															<img src="./user/images/uploads/cast5.jpg" alt="">
													...
													<div class="cast-it">
														<div class="cast-left">
															<img src="./user/images/uploads/cast6.jpg" alt="">
													...
													<div class="cast-it">
														<div class="cast-left">
															<img src="./user/images/uploads/cast7.jpg" alt="">
													...
													<div class="cast-it">
														<div class="cast-left">
															<img src="./user/images/uploads/cast9.jpg" alt="">
										...
										<div class="row">
											...
											<div class="mv-user-review-item">
												<div class="user-infor">
													<img src="./user/images/uploads/userava1.jpg" alt="">
													<div>
														<h3>Best Marvel movie in my opinion</h3>
														<div class="no-star">
															<i class="ion-android-star"></i> <i
											...
											<div class="mv-user-review-item">
												<div class="user-infor">
													<img src="./user/images/uploads/userava2.jpg" alt="">
													<div>
											...
											<div class="mv-user-review-item">
												<div class="user-infor">
													<img src="./user/images/uploads/userava3.jpg" alt="">
													<div>
											...
											<div class="mv-user-review-item ">
												<div class="user-infor">
													<img src="./user/images/uploads/userava4.jpg" alt="">
													<div>
											...
											<div class="mv-user-review-item last">
												<div class="user-infor">
													<img src="./user/images/uploads/userava5.jpg" alt="">
													<div>
									...
									<div id="cast" class="tab">
										<div class="row">
											...
											<div class="mvcast-item">
												<div class="cast-it">
													<div class="cast-left">
														<img src="./user/images/uploads/cast1.jpg" alt=""> <a
												...
												<div class="cast-it">
													<div class="cast-left">
														<img src="./user/images/uploads/cast2.jpg" alt=""> <a
												...
												<div class="cast-it">
													<div class="cast-left">
														<img src="./user/images/uploads/cast3.jpg" alt=""> <a
															href="#">Mark Ruffalo</a>
													</div>
													<p>... Bruce Banner/ Hulk</p>
												</div>
												<div class="cast-it">
													<div class="cast-left">
														<img src="./user/images/uploads/cast4.jpg" alt=""> <a
															href="#">Chris Evans</a>
													</div>
													<p>... Steve Rogers/ Captain America</p>
												</div>
												<div class="cast-it">
													<div class="cast-left">
														<img src="./user/images/uploads/cast5.jpg" alt=""> <a
												...
												<div class="cast-it">
													<div class="cast-left">
														<img src="./user/images/uploads/cast6.jpg" alt=""> <a
												...
												<div class="cast-it">
													<div class="cast-left">
														<img src="./user/images/uploads/cast7.jpg" alt=""> <a
															href="#">James Spader</a>
													</div>
													<p>... Ultron</p>
												</div>
												<div class="cast-it">
													<div class="cast-left">
														<img src="./user/images/uploads/cast9.jpg" alt=""> <a
															href="#">Don Cheadle</a>
													</div>
													<p>... James Rhodes/ War Machine</p>
												</div>
										...
										<div class="row">
											...
											<div class="mvsingle-item media-item">
												<div class="vd-item">
													<div class="vd-it">
														<img class="vd-img"
															src="./user/images/uploads/vd-item1.jpg" alt=""> <a
												...
												<div class="vd-item">
													<div class="vd-it">
														<img class="vd-img"
															src="./user/images/uploads/vd-item2.jpg" alt=""> <a
															class="fancybox-media hvr-grow"
															href="https://www.youtube.com/embed/o-0hcF97wy0"><img
															src="./user/images/uploads/play-vd.png" alt=""></a>
													</div>
												...
												<div class="vd-item">
													<div class="vd-it">
														<img class="vd-img"
															src="./user/images/uploads/vd-item3.jpg" alt=""> <a
															class="fancybox-media hvr-grow"
															href="https://www.youtube.com/embed/o-0hcF97wy0"><img
															src="./user/images/uploads/play-vd.png" alt=""></a>
													</div>
												...
												<div class="vd-item">
													<div class="vd-it">
														<img class="vd-img"
															src="./user/images/uploads/vd-item4.jpg" alt=""> <a
															class="fancybox-media hvr-grow"
															href="https://www.youtube.com/embed/o-0hcF97wy0"><img
															src="./user/images/uploads/play-vd.png" alt=""></a>
													</div>
											...
											<div class="mvsingle-item">
												<a class="img-lightbox" data-fancybox-group="gallery"
													href="./user/images/uploads/image11.jpg"><img
													src="./user/images/uploads/image1.jpg" alt=""></a> <a
													class="img-lightbox" data-fancybox-group="gallery"
													href="./user/images/uploads/image21.jpg"><img
													src="./user/images/uploads/image2.jpg" alt=""></a> <a
													class="img-lightbox" data-fancybox-group="gallery"
													href="./user/images/uploads/image31.jpg"><img
													src="./user/images/uploads/image3.jpg" alt=""></a> <a
													class="img-lightbox" data-fancybox-group="gallery"
													href="./user/images/uploads/image41.jpg"><img
													src="./user/images/uploads/image4.jpg" alt=""></a> <a
													class="img-lightbox" data-fancybox-group="gallery"
													href="./user/images/uploads/image51.jpg"><img
													src="./user/images/uploads/image5.jpg" alt=""></a> <a
													class="img-lightbox" data-fancybox-group="gallery"
													href="./user/images/uploads/image61.jpg"><img
													src="./user/images/uploads/image6.jpg" alt=""></a> <a
													class="img-lightbox" data-fancybox-group="gallery"
													href="./user/images/uploads/image71.jpg"><img
													src="./user/images/uploads/image7.jpg" alt=""></a> <a
													class="img-lightbox" data-fancybox-group="gallery"
													href="./user/images/uploads/image81.jpg"><img
													src="./user/images/uploads/image8.jpg" alt=""></a> <a
													class="img-lightbox" data-fancybox-group="gallery"
													href="./user/images/uploads/image91.jpg"><img
													src="./user/images/uploads/image9.jpg" alt=""></a> <a
													class="img-lightbox" data-fancybox-group="gallery"
													href="./user/images/uploads/image101.jpg"><img
													src="./user/images/uploads/image10.jpg" alt=""></a> <a
													class="img-lightbox" data-fancybox-group="gallery"
													href="./user/images/uploads/image111.jpg"><img
													src="./user/images/uploads/image1-1.jpg" alt=""></a> <a
													class="img-lightbox" data-fancybox-group="gallery"
													href="./user/images/uploads/image121.jpg"><img
													src="./user/images/uploads/image12.jpg" alt=""></a> <a
													class="img-lightbox" data-fancybox-group="gallery"
													href="./user/images/uploads/image131.jpg"><img
													src="./user/images/uploads/image13.jpg" alt=""></a> <a
													class="img-lightbox" data-fancybox-group="gallery"
													href="./user/images/uploads/image141.jpg"><img
													src="./user/images/uploads/image14.jpg" alt=""></a> <a
													class="img-lightbox" data-fancybox-group="gallery"
													href="./user/images/uploads/image151.jpg"><img
													src="./user/images/uploads/image15.jpg" alt=""></a> <a
													class="img-lightbox" data-fancybox-group="gallery"
													href="./user/images/uploads/image161.jpg"><img
													src="./user/images/uploads/image16.jpg" alt=""></a> <a
													class="img-lightbox" data-fancybox-group="gallery"
													href="./user/images/uploads/image171.jpg"><img
													src="./user/images/uploads/image17.jpg" alt=""></a> <a
													class="img-lightbox" data-fancybox-group="gallery"
													href="./user/images/uploads/image181.jpg"><img
													src="./user/images/uploads/image18.jpg" alt=""></a> <a
													class="img-lightbox" data-fancybox-group="gallery"
													href="./user/images/uploads/image191.jpg"><img
													src="./user/images/uploads/image19.jpg" alt=""></a> <a
													class="img-lightbox" data-fancybox-group="gallery"
													href="./user/images/uploads/image201.jpg"><img
													src="./user/images/uploads/image20.jpg" alt=""></a> <a
													class="img-lightbox" data-fancybox-group="gallery"
													href="./user/images/uploads/image211.jpg"><img
													src="./user/images/uploads/image2-1.jpg" alt=""></a>
											</div>
										</div>
									</div>
									<div id="moviesrelated" class="tab">
										<div class="row">
											...
											<div class="movie-item-style-2">
												<img src="./user/images/uploads/mv2.jpg" alt="">
												<div class="mv-item-infor">
													<h6>
											...
											<div class="movie-item-style-2">
												<img src="./user/images/uploads/mv3.jpg" alt="">
												<div class="mv-item-infor">
													<h6>
											...
											<div class="movie-item-style-2">
												<img src="./user/images/uploads/mv4.jpg" alt="">
												<div class="mv-item-infor">
													<h6>
											...
											<div class="movie-item-style-2">
												<img src="./user/images/uploads/mv5.jpg" alt="">
												<div class="mv-item-infor">
													<h6>
